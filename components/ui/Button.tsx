...
export default function Button({
  ...
  const classes = `inline-flex items-center justify-center gap-2 rounded-full transition-all duration-200 w-full sm:w-auto text-center ${variants[variant]} ${sizes[size]} ${className}`;
